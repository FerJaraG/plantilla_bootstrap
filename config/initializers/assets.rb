...
Rails.application.config.assets.paths << Rails.root.join('vendor','vendor','font-awesome','font')
...
Rails.application.config.assets.paths << Rails.root.join('vendor','vendor','simple-line-icons','font')
...
Rails.application.config.assets.precompile += %w( *.svg *.eot *.woff *.ttf *.woff2 *.map )
